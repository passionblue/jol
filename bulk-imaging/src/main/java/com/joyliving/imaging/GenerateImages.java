...
public class ResizeNoscaling {

    private static Logger m_logger = LoggerFactory.getLogger(ResizeNoscaling.class);
    ...
    private boolean renameOutFiles = true; // if true, rename file with parent
                                           // directory name
...
//        process_SAS();
    ...
    public static void process_Nike_FlyKnitRacer() throws Exception {
        ...
        ResizeNoscaling resize = new ResizeNoscaling();
